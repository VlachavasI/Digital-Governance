var languageContent = {
    greek: {
      ...
      infoTitle: "Πληροφορίες για την χορήγηση Επιδόματος Τέκνων",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε το επίδομα.",
    ...
    english: {
      ...
      infoTitle: "Information on granting the Child Benefit",
      subTitle1: "This questionnaire can help you determine if you are eligible to receive the allowance.",
